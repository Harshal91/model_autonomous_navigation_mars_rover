...
if (~strcmpi(point_option, 'convex hull'))
    ...
    % Assemble point cloud middle_rim_pts_1
    point_cloud = unique([outer_rim_pts ; inner_rim_pts],'rows');
   
    % Use this for reduced set of points 
    % point_cloud = point_cloud(1:2:length(point_cloud),:);
