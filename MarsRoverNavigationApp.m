        ...
        function startupFcn(app)
          ...
          %  app.Exercise1Panel.collapse;
            ...
            Map = createBinaryOccupancyGrid(app.xg,app.yg,...
                ...
                app.round_rocks_pts,...
                app.ditches_pts,...
                1.2,...%str2double(app.MapObstaclesInflationRadiusEditField.Value),...
                app.rocks_select);
            ...
            endLocation_ex1 = endLocation;%[startLocation(1)+5 startLocation(2) startLocation(3)];
...
%             app.Exercise1Panel.Title = 'Calibration';
...
%             createEx1Components(app, pnlGL1);
            ...
            app.Exercise2Panel.Title = 'Object Detection';
            app.Exercise2Panel.Collapsed = true;
            ...
            app.Exercise3Panel.Title = 'Navigation';
            ...
            pnlGL3 = uigridlayout(app.Exercise3Panel, [11 3]);
...
%             app.UpdateGoalLocationVizEx1.FontWeight = 'bold';
        ...
        function createEx3Components(app, gridlayout)
            ...
            title1 = uilabel(gridlayout);
            title1.Enable = 'on';
            title1.Layout.Row = 1;
            title1.Layout.Column = 1;
            title1.Text = 'Terrain Obstacles';
            title1.FontSize = 12;
            ...
            app.TerrainPointsBelowSlopeAngdegSliderLabel.Layout.Row = 4;
            ...
            title2 = uilabel(gridlayout);
            title2.Enable = 'on';
            title2.Layout.Row = 6;
            title2.Layout.Column = 1;
            title2.Text = 'Mars Rover Goal Location';
            title2.FontSize = 12;
            title2.FontWeight= 'Bold';

            editfieldLayout = uigridlayout(gridlayout, [4 5]);
            editfieldLayout.Layout.Row = [7 8];
...
% 
%             title3 = uilabel(gridlayout);
%             title3.Enable = 'on';
%             title3.Layout.Row = 9;
%             title3.Layout.Column = 1;
%             title3.Text = '';
%             title3.FontSize = 10;
